...
- Щоб додати тему: ТІЛЬКИ /cur_add Назва теми (не /cur add — такого не існує!)
- Якщо пропонуєш додати кілька тем — пиши окремі команди: /cur_add Тема1, потім /cur_add Тема2
...
def _get_curriculum_list():
    try:
        ...
        import logging
        logging.getLogger("sam").warning(f"_get_curriculum_list v2 read failed: {e}")
        return []
